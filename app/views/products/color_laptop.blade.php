...
@section('title')
    ZENO - {{Lang::get('page.colorlaptop')}}
@stop
@section('keywords')
    {{Lang::get('page.colorlaptop')}}
@stop
@section('description')
    {{Lang::get('page.colorlaptop')}}
@stop
...
@section('side_content')
    <div class="col2">
        <h4 class="heading colr">{{Lang::get('page.colorlaptop')}}</h4>
        <!-- Product Detail -->
        <div class="prod_detail">
            ...
            <div class="desc">
                <h2>{{Lang::get('page.colorlaptop')}}</h2>
                <a href="mailto:info@zeno-med.com?subject={{Lang::get('page.colorlaptop')}}" class="email">{{Lang::get('page.email_to_us')}}</a>
                <div class="clear"></div>
                <br/>
