                ...
                <div class="tab_container">
                    <div class="tab_container_in">
                        ...
                        <div id="tab_sidebar_recent" class="tab_sidebar_list">
                            <h4>功能特点</h4><br />
                            <p class="des">由于不同型号产品配套的探头有所不同，请咨询销售人员来购买探头</p>
                            <br/>
                            <a href="{{url('contact')}}" class="simplebtn">Contact Now!</a>
                            <br/><br/>

                            <img src="{{asset('images\products\probes\probes_d_1.jpg')}}" alt=""/>
                            <br/><br/>
                            <img src="{{asset('images\products\probes\probes_d_2.jpg')}}" alt=""/>
                            <br/><br/>
                            <img src="{{asset('images\products\probes\probes_d_3.jpg')}}" alt=""/>
                        </div>
                        <!-- END -->
